...
def generate_detector_params(caminho_pasta_output):
    ...
    arucoParams.adaptiveThreshWinSizeMax = 55                           # Padrão = 23 (pixels)
    ...
    arucoParams.polygonalApproxAccuracyRate = 0.005                     # Padrão = 0.03 (pixels)
    arucoParams.cornerRefinementMethod = cv2.aruco.CORNER_REFINE_SUBPIX
    arucoParams.cornerRefinementWinSize =  25                           # Padrão = 5 pixels
    arucoParams.cornerRefinementMaxIterations = 80                      # Padrão = 30 iterações
