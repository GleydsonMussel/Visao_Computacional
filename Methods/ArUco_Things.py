...
def generate_detector_params(caminho_pasta_output):
    ...
    arucoParams.adaptiveThreshConstant = 9                              # Padrão = 7  
    arucoParams.minMarkerPerimeterRate = 0.01                           # Padrão = 0.03 (%) 
    arucoParams.maxMarkerPerimeterRate = 4.0                            # Padrão = 4.0 (%)
    arucoParams.perspectiveRemovePixelPerCell = 24                       # Padrão = 4 pixels
    arucoParams.perspectiveRemoveIgnoredMarginPerCell = 0.13            # Padrão = 0.13 (%)
    ...
    arucoParams.polygonalApproxAccuracyRate = 0.0085                     # Padrão = 0.03 (pixels)
    arucoParams.cornerRefinementMethod = cv2.aruco.CORNER_REFINE_SUBPIX
    arucoParams.cornerRefinementWinSize =  20                           # Padrão = 5 pixels
    arucoParams.cornerRefinementMaxIterations = 200                      # Padrão = 30 iterações
